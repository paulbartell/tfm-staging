 ...
 *
 * 0x0000_0000 BL2 - counters (8 KB)                    0x0_2000
 * 0x0000_2000 BL2 - MCUBoot (128 KB)                   0x2_0000
 * 0x0002_2000 OTP Write Protect (8 KB)                 0x0_2000
 * 0x0002_4000 NV counters area (16 KB)                 0x0_4000
 * 0x0002_8000 Secure Storage Area (16 KB)              0x0_4000
 * 0x0002_C000 Internal Trusted Storage Area (16 KB)    0x0_4000
 * 0x0003_0000 Secure image     primary slot (256 KB)   0x4_0000
 * 0x0007_0000 Non-secure image primary slot (640 KB)   0xA_0000
 * 0x0011_0000 Secure image     secondary slot (256 KB) 0x4_0000
 * 0x0015_0000 Non-secure image secondary slot (640 KB) 0xA_0000
 * 0x001F_0000 SCRATCH (64KB)                           0x1_0000
 * 0x0020_0000 End
 *
 * Bl2 binary is written at 0x1_2000:
 * it contains bl2_counter init value, OTP write protect, NV counters area init.
 * Note: Blocks must be 8Kbyte aligned to allow the use of the WRP, HDP and SECWM features.
 */
...
#define FLASH_BL2_HDP_STRT              ( 0 )

/* area for bl2 anti roll back counter */
#define FLASH_BL2_NVCNT_AREA_OFFSET     ( 0 )
#define FLASH_BL2_NVCNT_AREA_SIZE       ( 0x2000 ) /* 8KB */
...
#define FLASH_AREA_BL2_NOHDP_CODE_SIZE  ( 0x2000 )  /* 8 KB */

#define FLASH_AREA_OTP_OFFSET           ( FLASH_AREA_BL2_NOHDP_OFFSET + FLASH_AREA_BL2_NOHDP_CODE_SIZE )
#define FLASH_AREA_OTP_SIZE             ( 0x2000 )  /* 8 KB */
...
#define FLASH_NV_COUNTERS_AREA_SIZE     ( 0x4000 ) /* 16 KB */
...
/* scratch area */
#define FLASH_AREA_SCRATCH_OFFSET       ( 0x1F0000 )
